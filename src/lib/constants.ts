...
export const SERRAMENTI_PRODUCTS = [
  ...
  { title: "Infissi in Alluminio",              image: "/images/serramenti2.jpg", desc: "Soluzioni leggere e moderne in alluminio con diverse finiture disponibili." },
  { title: "Infissi in PVC",                    image: "/images/serramenti3.jpg", desc: "Eccellente isolamento termoacustico con profili in PVC di alta qualità." },
  { title: "Infissi Legno e Alluminio",         image: "/images/serramenti4.jpg", desc: "Il calore del legno all'interno, la resistenza dell'alluminio all'esterno." },
  { title: "Alluminio Verniciato Effetto Legno", image: "/images/serramenti5.jpg", desc: "L'estetica del legno con le prestazioni dell'alluminio." },
  { title: "Verande in Alluminio",              image: "/images/serramenti6.jpg", desc: "Verande su misura in alluminio per ampliare gli spazi vivibili." },
] as const;

export const CARPENTERIA_PRODUCTS = [
  { title: "Scale in Ferro",          image: "/images/carp1.jpg", desc: "Scale in ferro e acciaio per uso interno ed esterno, civile e industriale." },
  ...
  { title: "Portoni Industriali",     image: "/images/carp3.jpg", desc: "Portoni scorrevoli in acciaio con pannelli sandwich per capannoni industriali." },
  { title: "Tettoie con Pannelli FV", image: "/images/carp4.jpg", desc: "Strutture in acciaio con copertura fotovoltaica integrata." },
  ...
  { title: "Cappa in Inox",          image: "/images/carp6.jpg", desc: "Struttura in acciaio inox con pannelli in rame e rete anti-insetti." },
] as const;
...
export const NAUTICA_PRODUCTS = [
  ...
  { title: "Griglie Inox e Alluminio",     image: "/images/nautica3.jpg", desc: "Griglie di aerazione e protezione in acciaio inox e alluminio." },
  { title: "Isola Salpancore",             image: "/images/nautica4.jpg", desc: "Strutture per prua con integrazione verricelli e sistemi di ancoraggio." },
